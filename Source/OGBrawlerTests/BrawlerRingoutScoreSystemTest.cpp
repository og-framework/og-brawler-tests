...
{
    static_assert(FScoreCompositeWireSize<simulatableBrawler::State>::value == 335u,
        ...
        "to prevent. Budget against ~14 B (F13), not the buffer's 41 B.");
    REQUIRE(FScoreCompositeWireSize<simulatableBrawler::State>::value == 335u);
