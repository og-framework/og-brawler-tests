...
CATCH_REGISTER_TAG_ALIAS("[@og]",
    "[DAttack],[CharacterViz],[SimulatableBrawler],[SimulationComposite],[SimulationIntegrationExecutor],[SimulationNetSync],[SimulationReconciliation],[InputSequence],[BrawlerProjectile],[InputPackaging],[PacketBudget]")
